...
import {
  X, Phone, Building2, DollarSign, User, MapPin, Clock,
  PhoneCall, Users, FileText, Calendar, CheckCircle2,
  ChevronDown, Trash2, Send, Video, ArrowRightLeft,
  Loader2, ChevronRight, Upload, Check, Plus, AlertCircle
} from 'lucide-react';
...
import { getLeadScore, getProgramaStyle, calcLeadScore } from '../../shared/lib/leadScore';
