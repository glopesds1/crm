...
import { X, Calendar, Loader2, Upload } from 'lucide-react';
import { supabase } from '../../shared/lib/supabase';
import { localDatetimeToISO } from '../../shared/lib/dateHelpers';
import { syncPostgres, WEBHOOK_BASE } from '../../shared/lib/webhooks';
import type { CRMLead, CRMAtividade, CRMTarefa, TeamMember } from '../../shared/types';
...
export interface NovaAtividadeFormProps {
  ...
  leadName: string;
  userSession: any;
  onSaved: (a: CRMAtividade) => void;
  onCancel: () => void;
  onLeadUpdated?: (upd: Partial<CRMLead>) => void;
...
export function NovaAtividadeForm({ lead: leadObj, leadId, leadName, userSession, onSaved, onCancel, onLeadUpdated, onClientCreated, onTarefaCreated, teamMembers = [], initialTipo }: NovaAtividadeFormProps) {
