...
import { Bell, X, Clock, Calendar, ChevronRight, Loader2, Phone, Building2, Users, User } from 'lucide-react';
import { supabase } from '../../shared/lib/supabase';
import type { CRMTarefa, CRMLead } from '../../shared/types';
import { fmtDateSP } from '../../shared/lib/dateHelpers';
...
interface TaskAlarmPopupProps {
  ...
  onReschedule: (novaData: string) => void;
}

export function TaskAlarmPopup({ tarefa, lead, onDismiss, onOpenLead, onComplete, onReschedule }: TaskAlarmPopupProps) {
